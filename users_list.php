...
.sidebar-title { font-size: 1rem; font-weight: 600; margin-bottom: 20px; }
.side-link {
    display: flex; align-items: center; gap: 8px;
    padding: 8px 10px; font-size: 0.9rem;
    color: #9ca3af; border-radius: 8px; text-decoration: none;
}
.side-link.active, .side-link:hover { background-color: #111827; color: #fff; }
.main-area { flex: 1; background-color: #020617; }
.main-header { padding: 16px 24px; border-bottom: 1px solid #111827; }
...
.table-dark-custom { font-size: 0.85rem; }
...
<div class="layout-wrapper">
    ...
    <aside class="sidebar">
        ...
        <a href="stories_list.php" class="side-link">
            <span class="icon">📖</span><span>Stories</span>
        </a>
        <a href="users_list.php" class="side-link active">
