...
<head>
    <meta charset="UTF-8">
    <title>Your Story Dashboard</title>
...
<body>
    ...
    <script>
        ...
        async function loadStats() {
            const res = await fetch('fetch_user_story_stats.php');
        ...
        async function loadTable() {
            const res = await fetch('fetch_user_story_table.php');
